...
<head>
    ...
    <%--<script src="${pageContext.request.contextPath}/resources/app/Demo/Interface/IDocumentScope.js"></script>--%>
    ...
    <section id="content">
        <div class="page-content">
            ...
            <div class="page-padding" ng-controller="DocumentListController as ctlr">
                <%--<form name="Documentform" (ngSubmit)="f.form.valid" #f="ngForm" novalidate>--%>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-7 col-lg-7">
                                        <h4 class="doc-header"><img src="${pageContext.request.contextPath}/resources/content/Document/Images/back.png" class="doc-back-image" /><a href="Javascript:void(0)"></a>Document upload</h4>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group form-group" style="height:48px;">
                                                    ...
                                                    <button class="form-control" style="height:100%;width:100%;background-color:#F0F0F0;padding-left:25px;" ng-click="ctlr.TestData(ctlr)">Discard</button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-group form-group" style="height:48px;" ng-class="{'disable-btn': !(ctlr.Isvalid)}">
                                                    ...
                                                    <button class="form-control" style="height:100%;width:100%;background-color:#F0F0F0;padding-left:25px;" type="submit"  ng-disabled="Documentform.$invalid">Import</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="doc-form-div">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="doc-upload-button"  type="file" ngf-select="ctlr.uploadFiles($file, $invalidFiles)"
                                ...
                                <div class="form-group">
                                    ...
                                    <select kendo-multi-select k-ng-model="doc.documentTags" multiple="multiple" data-placeholder="Please select ..." id="selectDocumentTags">
...
<script>
    $('#txtcreationDate, #txtvalidFromDate, #txtvalidToDate').datepicker({
        format: 'yyyy-mm-dd',
        autoclose: true
    });
</script>
