...
public class DocumentDataControllerTest {
    ...
    public static List<DocumentLinkDTO> documentLinkDTO = new ArrayList<DocumentLinkDTO>();
    {documentLinkDTO.add(documentlinkDTO);}

    public static DocumentDTO documentDTO = new DocumentDTO( "ProjectA",DateUtil.parseDatetime("2017-05-16T00:00:00.000Z"),
            DateUtil.parseDatetime("2017-05-16T00:00:00.000Z"),DateUtil.parseDatetime("2017-05-16T00:00:00.000Z"),
            DateUtil.parseDatetime("2017-05-16T00:00:00.000Z"), VerticalData.BOI, DocumentStatus.ForYourInformation,
            DocumentType.Account_Statement, AddressScope.UserId,documentLinkDTO);
    ...
    public void test1FileUpload_Save(){
        ...
        ResponseEntity<String> responseEntity = this.restTemplate.postForEntity("/fileUpload", requestEntity, String.class);
    ...
    public void test2Document_Save(){
        ResponseEntity<String> responseEntity = this.restTemplate.postForEntity("/AddDocument", documentDTO, String.class);
        String resp = responseEntity.getBody();
    ...
    public void test3Document_List_By_Id(){
        ResponseEntity<DocumentDTO> responseEntity = this.restTemplate.getForEntity("/documentListByID/"+documentDTO.getDocumentId(), DocumentDTO.class);
    ...
    public void test4Document_Update(){
        ...
        ResponseEntity<DocumentDTO> responseEntity = this.restTemplate.postForEntity("/updateDocument", documentDTO, DocumentDTO.class);
    ...
    public void test5Document_Delete(){
        ResponseEntity<DocumentDTO> responseEntity = this.restTemplate.getForEntity("/deleteDocument/"+documentDTO.getDocumentId(),DocumentDTO.class);
        DocumentDTO status = responseEntity.getBody();
